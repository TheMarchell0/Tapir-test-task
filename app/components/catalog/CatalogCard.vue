<template>
  <a class="catalog-item">
    <img class="catalog-item__img" :src="product.image" :alt="product.name">
    <div class="catalog-item__prices">
      <p class="catalog-item__prices-item">
        {{ product.price }} ₽
      </p>
      <p class="catalog-item__prices-item catalog-item__prices-item--x2">
        {{ priceX2 }} ₽ × 2
      </p>
    </div>
